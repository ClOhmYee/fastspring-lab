...
class TestMain:
    ...
    # request POST "/api/messages" endpoint with the data and verify the expected response
    def test_receive_endpoint(self):
        request_data = {"message": "hello"}
        response = self.client.post("/api/messages", json=request_data)
    ...
    # request POST "/api/messages" endpoint with the invalid request and verify the validation error
    ...
    # request POST "/api/messages" endpoint with non-str type message
